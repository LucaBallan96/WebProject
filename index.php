...
<html lang="it">
	...
	<body>
		...
		<div class="nascosto"><div class="logo_nascosto"><img src="images/logo_azzurro.png" alt="logo Costruzioni Bordignon S.r.l."/></div>Ti trovi in: Home</div>
		<div class="contall">
		<!--MESSAGGI-->
		<?php
		...
		<div id=div_container_storia>
			...
			<div id="div_storia">
				...
				<div id="div_text_storia">
					...
					La <a href="https://it.wikipedia.org/wiki/Norme_della_serie_ISO_9000" class="link_generico" target="_blank" title="certificazione ISO wikipedia">certificazione di qualità ISO</a>, l'<a href="https://it.wikipedia.org/wiki/Societ%C3%A0_organismi_di_attestazione" class="link_generico" target="_blank" title="certificazione SOA wikipedia">attestazione SOA</a> e
