...
<html lang="it">
	...
	<body>
		...
		<div class="nascosto"><div class="logo_nascosto"><img src="images/logo_azzurro.png" alt="logo Costruzioni Bordignon S.r.l."></div>Ti trovi in: Home > Lavora con Noi</div>
		<div class="contall">
		<!--OFFERTE-->
        <?php
            $conn->get_offer();
